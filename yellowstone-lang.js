...
const TRIP_ZH = {
  ...
  days: [
    ...
    },
    {
      ...
      blocks: [
        { time: "出发前", title: "❄️ 先查路况——Montana 511 和 Idaho 511", detail: "今天50%概率有阵雪，积雪预计不到半英寸。Targhee Pass（2,155米）在出镇十分钟处的 US-20 上，是整段路的最高点。查 mdt.mt.gov/511 和 511.idaho.gov。如果11点还在下雪，就等一两个小时——你只要傍晚前到盐湖城就行，路面回暖很快。租来的车是四季胎，没必要第一个去压雪泥。" },
        { time: "出发", title: "🚗 退房、离开西黄石", detail: "US-20 南下翻 Targhee Pass，经 Island Park、Ashton → Idaho Falls → I-15 南。约320英里，含一次停车约5小时。到 Idaho Falls 下降730米，到盐湖城再降270米，所以第一个小时之后天气就甩在身后了。" },
      ...
      tips: [
        ...
        "⚠️ 整个计划都假设你是周日比赛。周日只有女子双人、女子/适应组、男子双人三个组。如果你是男子单人（周五 08:00–09:00 或周六 08:00–11:20）或混合双人（周六 11:50–17:40），今天11点才出发就太晚了——得提前一天离开西黄石。",
        "把出发时间和晚上飞洛杉矶的航班对一下：完赛 + 冲澡 + 15分钟 Uber 到机场 + 提前2小时。14:50–16:40 的男子双人那一波最紧张。",
