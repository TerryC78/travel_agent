...
const TRIP_ZH = {
  ...
  days: [
    {
      title: "飞抵盐湖城 · 夜里取车 + 采购",
      summary: "旅行日。傍晚落地、取租车，然后一站式夜购：在中国城超市（周日开到10pm）买齐一周的中餐食材，附近再买厨具和保暖衣物。",
      blocks: [
        { time: "傍晚", title: "✈️ 落地 SLC → 取租车", detail: "租车柜台在航站楼/租车中心。记一下里程——9月19日下午还车。确认后备箱装得下一周的食物和装备。" },
        { time: "约晚上8:00", title: "🛒 中国城超市——买一周食材", detail: "3390 S State St（周日开到10pm，离机场约20分钟）。备齐米、面、米粉、馒头/包子（赛前碳水）、鸡蛋、鸡胸、豆腐、鱼、蔬菜、调料、粥料。没有保温袋的话买一个。" },
        { time: "约晚上9:00", title: "🍳 Target / Walmart——厨具和保暖衣物", detail: "锅、平底锅、住处没有的话买个电饭煲、餐具、保温壶，再加抓绒、帽子、手套——黄石清晨接近零度。多数店 10–11pm 关门，这是最后一站。" },
        { time: "夜里", title: "🏨 入住过夜", detail: "简单点——明早要跑腿，还有5小时车程。把所有设备充满电。" }
      ],
      eat: "在商店附近随便吃点快的；明天起自己做饭。",
      tips: [
    ...
    },
    {
      ...
      blocks: [
        { time: "出发前3小时", title: "🍚 赛前早餐", detail: "粥/白饭/燕麦 + 一根香蕉 + 少量蛋或鸡肉，出发前 2.5–3 小时吃。平时喝咖啡就照常。出发前 45–60 分钟：一根香蕉或一支胶 + 运动饮料。" },
  ...
  bookings: [
    ...
    "🛒 中国城超市购物清单（9月13日，周日开到10pm）：米、面、米粉、馒头/包子、鸡蛋、鸡胸、豆腐、鱼、蔬菜、调料、粥料、香蕉、蜂蜜",
    "🍳 Target/Walmart 厨具衣物清单：锅、平底锅、电饭煲（需要的话）、餐具、保温壶、保温袋、抓绒、帽子、手套",
