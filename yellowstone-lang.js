...
const UICOPY = {
  en: {
    ...
    weather_sub: "Sep 13 – 20. Shows typical mid-September averages until the dates come within forecast range (~16 days out), then auto-updates to the live forecast when online. Yellowstone mornings sit near freezing — watch the lows.",
  ...
  zh: {
    ...
    weather_sub: "9月13日 – 20日。在日期进入可预报范围（约提前16天）之前显示9月中旬的常年平均值，之后联网时会自动更新为实时预报。黄石清晨接近零度——注意最低温。",
...
const TRIP_ZH = {
  ...
  highlights: [
    ...
    "🍚 酒店房间没有厨房，所以一个电饭煲（9月13日买）就是这一周的灶：煮饭、煮粥、煮面、蒸馒头包子、煮蛋、焯青菜。其余食材第一晚在中国城超市买齐；一壶粥让日落观兽和摸黑回家的长途都舒服起来。"
  ],
  ...
  stays: [
    ...
    { hotel: "Dude & Roundup Motel（西黄石）", city: "西黄石", dates: "9月14–19日", area: "3 Madison Ave，Double Deluxe 房、多张床——离黄石西门只有一个街区，每天进园立刻出发（到 Madison Junction 14 英里），晚上摸黑回来也很快到。没有厨房，而且各房型是否有冰箱/微波炉不一定——这一周就靠一个电饭煲当灶。Starlink Mini 在停车场能用。" }
  ],

  days: [
    {
      title: "飞抵盐湖城 · 夜里取车 + 采购",
      summary: "旅行日。傍晚落地、取租车，然后一路向北一站式夜购：在中国城超市（周日开到10pm）买齐一周的中餐食材，再买个电饭煲和保暖衣物——酒店房间没有厨房，这个电饭煲就是全部的厨房。",
      blocks: [
        { time: "傍晚", title: "✈️ 落地 SLC → 取租车", detail: "租车柜台在航站楼/租车中心。记一下里程——9月19日下午还车。确认后备箱装得下一周的食物和装备。" },
        { time: "约晚上8:00", title: "🛒 中国城超市——买一周食材", detail: "3390 S State St（周日开到10pm，离机场约20分钟）。按“只有电饭煲、没有灶”来买：米、粥料、面条、馒头/包子（赛前碳水）、速冻饺子、鸡蛋、熟食/卤味、豆腐、叶菜、调料、香蕉、蜂蜜。再买个保温袋——房间可能没冰箱。" },
        { time: "约晚上9:00", title: "🍳 Target / Walmart——电饭煲和保暖衣物", detail: "最关键的一件：**电饭煲**（酒店没厨房——它能煮饭、煮粥、煮面，蒸馒头饺子，煮蛋，焯青菜）。再加碗筷餐具、小刀+砧板、保温壶、洗洁精+海绵，以及抓绒、帽子、手套——黄石清晨接近零度。锅和平底锅不用买，没有灶。多数店 10–11pm 关门，这是最后一站。" },
    ...
    },
    {
      ...
      blocks: [
        ...
        { time: "约晚上8:00", title: "🏠 入住 Dude & Roundup Motel", detail: "3 Madison Ave，离西门一个街区——5晚的大本营。把电饭煲支起来（问一下前台在哪儿用合适），先把饭或粥焖上，把 Starlink Mini 放在能看到开阔天空的地方。再去接一桶冰放保温袋。" }
      ],
    ...
    },
    {
      ...
      tips: [
        ...
        "今晚把徒步装备收进包里——用不上了；熊喷雾不能上飞机，留在酒店或送人。"
      ]
    },
    {
  ...
  bookings: [
    ...
    "✅ Dude & Roundup Motel，西黄石（3 Madison Ave）— Double Deluxe、多张床，9月14–19日。⚠️ 没有厨房：提前打电话问清 (a) 房间有没有冰箱和微波炉，(b) 房间里能不能用电饭煲",
    "🍚 9月13日务必买一个电饭煲 — 没有厨房，它就是这一周的灶：煮饭、煮粥、煮面、蒸馒头饺子、煮蛋、焯青菜",
    ...
    "🐻 熊喷雾——在 Jackson 或西黄石买（约$45–50）；不能上飞机",
    "🛒 中国城超市购物清单（9月13日，周日开到10pm）——按电饭煲能做的买：米、粥料、面条、馒头/包子、速冻饺子、鸡蛋、熟食/卤味、豆腐、叶菜、调料、香蕉、蜂蜜",
    "🍳 Target/Walmart 清单：电饭煲、碗筷餐具、小刀+砧板、保温壶、保温袋、洗洁精+海绵、抓绒、帽子、手套（不用买锅——没有灶）",
  ...
  packing: {
    ...
    "Cooking & food": ["电饭煲（9月13日买——酒店没厨房）", "碗、筷子、餐具、小刀 + 砧板", "保温袋 + 去酒店冰机接冰（房间可能没冰箱）", "洗洁精 + 海绵 + 几个食物盒", "米、粥料、面条、馒头/包子（赛前碳水）", "鸡蛋、速冻饺子、熟食/卤味、豆腐、叶菜、调料", "香蕉、蜂蜜、果汁、米饼（碳水加载补充）", "电解质片/运动饮料"],
