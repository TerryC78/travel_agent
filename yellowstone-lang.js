...
const TRIP_ZH = {
  ...
  highlights: [
    "⚠️ 先确认你的 HYROX 组别。9月20日（周日）只有三个组：女子双人 07:00–11:50、女子/适应组 12:20–14:20、男子双人 14:50–16:40。男子单人是周五 08:00–09:00 或周六 08:00–11:20，混合双人是周六 11:50–17:40——如果你在这几个组里，9月19日才往回开就太晚了，整周都得改。出发前先在 HYROX App 里把组别和出发时间确认清楚。",
    "🐻 灰熊区：任何步道都要带熊喷雾。要租、不要买——进园路上在 Jackson 租（5天约$28），最后在西黄石还掉，比买便宜，而且反正不能带上飞机。离熊/狼 100 码、野牛/麋鹿 25 码；9月 Mammoth 的麋鹿发情期是亮点，但公鹿会冲人。",
    "🎫 门票：黄石每车 $35（7天）。大提顿一直是单独收（另外 $35），不过2026年有些资料说一张就能进两个park——买 $80 的 America the Beautiful 年票最多多花 $10，还能管一年，省得纠结。⚠️ 2026年新规：16岁以上的非美国居民每人要另加 $100，除非持年票（非居民版年票 $250）。车上都是美国居民的话就不用管这条。",
    ...
    "❄️ 冷锋到了：9月18日西黄石有阵雪（最高约10°C，夜里 −5°C），9月19日开车那天还有阵雪（最高约7°C，积雪不到半英寸）。Targhee Pass 就在出镇十分钟处——出发前查 Montana 511 和 Idaho 511，如果11点还在下就再等一两个小时。到了盐湖城又是30°C出头，所以抓绒放在手边、里面穿短袖。",
  ...
  days: [
    ...
    },
    {
      ...
      tips: [
        ...
        "门票：黄石每车 $35（7天）；大提顿通常单独再收 $35。2026年各方资料对「一张能不能进两个park」说法不一——买 $80 的 America the Beautiful 年票最省心。非美国居民请看概览里 $100 附加费那条。",
    ...
    {
      title: "黄石 Day 4 · 下雪天——先躲室内，雪停了再收尾",
      summary: "冷锋到了：下午3点前有阵雪，最高约10°C。所以今天顺序反过来——下雪的时候先进室内看灰熊与狼探索中心，雪势缓了再去那两个路边小站，然后休息、碳水加载、打包。离比赛两天，低强度的一天正合适。",
      blocks: [
        { time: "约上午10:30", title: "🐻 灰熊与狼探索中心（下雪就先进室内）", detail: "201 S Canyon St，离酒店几个街区。因为有阵雪挪到上午：常驻的灰熊、一个狼群、还有猛禽，都能近距离看——这一周你举着望远镜找的东西，这里给你保证版，而且完全不用开车。约1.5小时，基本都在室内。" },
        { time: "约中午12:30", title: "🔁 还熊喷雾——Freeheel & Wheel", detail: "33 Yellowstone Ave（406-646-7744），每天 9am–5pm，离公园西门半个街区、离酒店约两个街区。今天就还掉：它不能上飞机、是租的，而且明早是看天气决定的出发，别再多一件事。" },
        { time: "约下午2:00", title: "🏠 在酒店吃午饭、休息、打包", detail: "大份碳水午餐，把脚翘起来。今晚就把车装好，别留到明早——万一早上在下雪，你只想上车就走。徒步装备收起来，公园部分结束了。" },
        { time: "约下午3:30", title: "🎨 Gibbon 瀑布与 Artists Paintpots（等雪缓了再去）", detail: "预报3点后阵雪转弱。这两个站就在你天天开过的 Madison–Norris 路上：路边停车位看 Gibbon 瀑布，再走1.6公里环线看 Artists Paintpots。离酒店15–25分钟。雪中的彩色泥泉很值得看——但路上有雪泥就果断放弃。" },
        { time: "傍晚", title: "🏃 唤醒跑，然后早点睡", detail: "15–20分钟很轻松的慢跑 + 4×15秒加速，穿厚一点——或者下雨夹雪就别跑了，做10分钟活动度就行。碳水大餐（米饭、面、馒头），然后睡觉。明天是看天气决定的行程，先查路况再定闹钟。" }
      ],
      eat: "正式碳水加载：每餐米饭/面/馒头，瘦肉蛋白，少油少纤维。10°C 的雪天，一碗热粥特别舒服。",
      tips: [
        "❄️ 下午3点前有阵雪，最高约10°C，今晚降到 −5°C。镇上基本不积雪，但今天的安排就是让你在最糟的时段待在室内。",
        "🔁 今天一定把熊喷雾还掉（Freeheel & Wheel，33 Yellowstone Ave，每天 9am–5pm）——别留到下雪的出发早上。",
        "今明两天碳水目标：每公斤体重约6–8克。米饼、香蕉、蜂蜜水和果汁补空档。",
        "今晚就把车装好。明天早上你只想查路况、吃饭、出发——不想在雪里搬行李。"
      ]
    },
    {
      title: "开回盐湖城 · 出发下雪、到达酷热",
      summary: "这是一段看天气的行程：离开西黄石时有阵雪、最高约7°C，出镇十分钟就要翻 Targhee Pass——到了盐湖城又暖了20多度。出发前先查路况，还车和退还所有东西，然后回市中心过赛前夜。",
      blocks: [
        { time: "出发前", title: "❄️ 先查路况——Montana 511 和 Idaho 511", detail: "周六 50% 概率有阵雪，积雪预计不到半英寸，而且夜里降到 −5°C。Targhee Pass（2,155米）在出镇十分钟处的 US-20 上，是整段路的最高点。9点出发时太阳还没来得及把山口晒开，所以走之前先看一眼：Idaho 511 在 US-20 的 Targhee Pass 和 Island Park 有实时摄像头（511.idaho.gov），Montana 511 覆盖最初十英里（mdt.mt.gov/511）。如果摄像头里路面是白的，就等到 10–11 点——9点走本来就下午2点到盐湖城，晚一小时一点都不亏。租来的四季胎，没必要第一个去压结冰的山口。" },
        { time: "上午9:00", title: "🚗 退房、离开西黄石", detail: "US-20 南下翻 Targhee Pass，经 Island Park、Ashton → Idaho Falls → I-15 南。约320英里，含一次停车约5小时，9点出发下午2点左右到盐湖城——比原计划早两小时，赛前很从容。" },
        { time: "最初45分钟", title: "❄️ 下雪路段——只有最开始那35英里", detail: "这趟车所有的下雪风险都集中在最开始，因为只有那一段是高地：约10英里处的 Targhee Pass（2,155米），然后是到约35英里的 Island Park 高原（1,860–2,100米）。过了 Ashton（1,600米，约55英里）就彻底下来了，Idaho Falls 往后又干又暖。后面唯一的小高点是爱达荷/犹他州界的 Malad Summit（约1,615米），但靠南很多、暖得多。Idaho 511 在 US-20 的 Targhee Pass 和 Island Park 有实时摄像头——出发前先看一眼路面。" },
        { time: "开约2小时", title: "⛽ Idaho Falls 加油、伸展", detail: "半程，已经完全出了雪区。加油、洗手间、走10分钟、补水。午饭吃保温袋里的（米饭+鸡肉）——熟悉、低纤维。" },
      ...
      tips: [
        "❄️ 出发时有阵雪、约7°C，傍晚到盐湖城30°C——一趟车温差20多度。第一个小时把抓绒放在手边，到了换短袖。",
        "⚠️ 你是周日比赛，所以今天9点出发等于多出一整天——下午2点左右到盐湖城，下午就能领参赛包，赛前还能睡个好觉。",
        "把周日的出发时间和晚上飞洛杉矶的航班对一下：完赛 + 冲澡 + 15分钟 Uber 到机场 + 提前2小时。14:50–16:40 的男子双人那一波最紧张。",
        "整个下午补水 + 电解质——在高原干燥环境待了一周，你的水分是欠着的，而明天预报30°C出头。",
        "今晚睡眠压倒一切；赛前两晚的睡眠比前一晚更重要，所以你已经存好了。"
      ]
    },
    {
      title: "HYROX 盐湖城 · 飞洛杉矶",
      summary: "比赛日，在市中心的 Salt Palace 会展中心——而且是个热天，30°C出头，早上还有雷雨风险。出发前 2.5–3 小时吃熟悉的早餐，好好热身，比赛，恢复——然后 Uber 去机场，晚上飞 LAX。",
      blocks: [
      ...
      tips: [
        "🥵 30°C出头，而你刚在2,000米的低温里待了一周——别硬上。从早餐就开始补电解质，不要等到出发线；第一个1公里比原计划还要再保守一点。",
        "⛈ 早上有雷雨风险：比赛在 Salt Palace 室内，但从酒店走过去的那10分钟不是。带件薄外套，包里放双干袜子。",
        "带上：号码布/参赛包、证件、穿惯的鞋、允许的话带镁粉、一套换洗衣服、自己的补给——比赛当天不试任何新东西。",
        "9月20日（周日）波次：女子双人 07:00–11:50 · 女子/适应组 12:20–14:20 · 男子双人 14:50–16:40。周日就只有这三个组——在 HYROX App 里确认你的。",
  ...
  logistics: [
    ...
    { label: "HYROX", value: "InBody HYROX 盐湖城 9月18日（周五）–20日（周日）在 Salt Palace 会展中心，90 S West Temple。周日只有三个组：女子双人 07:00–11:50、女子/适应组 12:20–14:20、男子双人 14:50–16:40。男子单人在周五 08:00–09:00 或周六 08:00–11:20；混合双人在周六 11:50–17:40。不需要车：从 Hyatt Place 步行约0.5英里（10分钟），之后打 Uber 去机场（约15分钟）。" },
  ...
  bookings: [
    ...
    "⚠️ HYROX——务必在 App 里确认组别和比赛日。9月20日（周日）只有女子双人、女子/适应组、男子双人三个组。男子单人在周五或周六；混合双人在周六下午。只要不是周日，9月19日往回开的安排就不成立",
    ...
    "🐻 熊喷雾——建议租，别买。取：Bear Aware @ Teton Backcountry Rentals，565 N Cache St, Jackson，每天 8am–6pm，(307) 828-1885——N Cache 就是 US-89，北上顺路。备选：Jackson Hole 机场 3 号行李转盘旁的自助点，9am–6pm。还：Freeheel & Wheel，33 Yellowstone Ave, West Yellowstone，每天 9am–5pm，406-646-7744（通常有24小时投递箱，但营业时间内走进去最稳妥）。前两天$16，之后每天$4，上限$28。买要约$45–50，而且不能带上飞机",
