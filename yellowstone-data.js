...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { time: "~12:30 PM", title: "🔁 Return the bear spray — Freeheel & Wheel", detail: "33 Yellowstone Ave (406-646-7744), open 9am–5pm daily, half a block from the park’s West Entrance and ~2 blocks from the motel. Do this today: it can’t fly home, it’s a rental, and tomorrow morning is a weather-dependent departure you don’t want to complicate.", map: "Grizzly and Wolf Discovery Center West Yellowstone" },
      ...
      tips: [
        ...
        "🔁 Return the bear spray TODAY (Freeheel & Wheel, 33 Yellowstone Ave, open 9am–5pm) — don’t leave it for a snowy departure morning.",
    ...
    },
    {
      ...
      blocks: [
        { time: "Before you leave", title: "❄️ Check the passes — Montana 511 & Idaho 511", detail: "Saturday brings a 50% chance of snow showers with under half an inch expected, and it drops to 23°F overnight. Targhee Pass (7,072 ft) is ten minutes out of town on US-20 and it’s the high point of the whole drive. A 9am departure is early enough that the sun hasn’t worked on the pass yet, so look before you go: Idaho 511 has live cameras on US-20 at Targhee Pass and Island Park (511.idaho.gov), and Montana 511 covers the first ten miles (mdt.mt.gov/511). If the camera shows white, wait until 10–11 — leaving at 9 already lands you in Salt Lake around 2pm, so an hour costs you nothing. A rental on all-season tyres has no business being first over a frozen pass.", map: "Dude and Roundup Motel West Yellowstone" },
        { time: "9:00 AM", title: "🚗 Check out & depart West Yellowstone", detail: "US-20 south over Targhee Pass through Island Park and Ashton → Idaho Falls → I-15 south. ~320 miles, ~5 hrs with a stop, so a 9am start puts you in Salt Lake around 2pm — two hours earlier than planned, and a comfortable buffer before race day." },
        { time: "First 45 min", title: "❄️ The snow zone — the first 35 miles only", detail: "All the snow risk on this drive is in the first stretch, because it’s the only high ground: Targhee Pass (7,072 ft) at ~10 miles, then the Island Park plateau (6,100–6,900 ft) to ~35 miles. After Ashton (5,259 ft, ~55 miles) you’ve dropped out of it, and Idaho Falls onward is dry and warm. The one later bump is Malad Summit (~5,300 ft) at the Idaho/Utah line, but it’s far south and much warmer. Idaho 511 has live cameras on US-20 at Targhee Pass and Island Park — look at the road before you commit.", map: "Targhee Pass US-20 Montana Idaho border" },
        { time: "~2 hrs in", title: "⛽ Fuel & stretch at Idaho Falls", detail: "Halfway, and well out of the snow. Gas, restroom, a 10-minute walk, refill water. Lunch from the cooler (rice + chicken) — familiar and low-fibre.", map: "Idaho Falls Idaho" },
      ...
      tips: [
        ...
        "⚠️ You race SUNDAY, so today’s 9am departure gives you a full extra day — arrive Salt Lake ~2pm, packet pickup this afternoon, and a proper night’s sleep before the race.",
        "Check your start time against the evening LAX flight on Sunday: finish + shower + a 15-min Uber to SLC + 2 hrs at the airport. The 14:50–16:40 Doubles Men wave is the tight one.",
  ...
  bookings: [
    ...
    "🐻 Bear spray — RENT it, don’t buy it. PICK UP: Bear Aware at Teton Backcountry Rentals, 565 N Cache St, Jackson, open 8am–6pm daily, (307) 828-1885 — N Cache is US-89, so it’s on the way north. Backup: the Jackson Hole Airport kiosk by baggage claim #3, 9am–6pm. DROP OFF: Freeheel & Wheel, 33 Yellowstone Ave, West Yellowstone, open 9am–5pm daily, 406-646-7744 (there is usually a 24/7 after-hours box, but walking in during hours is the sure thing). $16 for the first two days then $4/day, capped at $28. Buying is ~$45–50 and it can’t fly home",
...
const PLACES = {
  ...
  "Targhee Pass US-20 Montana Idaho border": [44.6850, -111.3100],
