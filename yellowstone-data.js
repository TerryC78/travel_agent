...
const TRIP = {
  ...
  highlights: [
    ...
    "🏋️ It’s HYROX taper week: Yellowstone is active recovery (boardwalks, one short hike), not training. The hard work is done; every day here is kept easy on the legs, and carb-loading starts Sep 17.",
    ...
    "🍚 You’re self-catering: Chinatown Supermarket on night one stocks the week, and congee in a thermos makes predawn wildlife mornings civilised."
  ],
  ...
  days: [
    ...
    },
    {
      ...
      summary: "Morning errands (Whole Foods package, Starlink Mini), then the ~5-hour drive to Grand Teton for the classic afternoon loop, and north through Yellowstone’s South Entrance to your West Yellowstone base by dark.",
      blocks: [
        { time: "~7:30 AM", title: "📦 Whole Foods — package pickup", detail: "Grab the package at the customer-service / Amazon counter as soon as they open. Coffee and breakfast here too.", map: "Whole Foods Market Salt Lake City" },
        { time: "~8:15 AM", title: "📡 Pick up the Starlink Mini", detail: "Power it up in the car and make sure the app is signed in before you leave cell coverage — there’s almost no service inside the park." },
        { time: "9:00 AM", title: "🚗 Depart SLC → Grand Teton (~5 hrs)", detail: "I-15 North → US-89 through Star Valley into Jackson (scenic), or I-15 → Idaho Falls → US-26 (a touch faster). Fuel up in Jackson and buy BEAR SPRAY here (~$45–50) — it’s grizzly country from here on.", map: "Jackson Wyoming" },
        { time: "~2:00 PM", title: "🏔 Mormon Row — the Moulton barns", detail: "The postcard: weathered barns with the Teton range behind. 20 minutes, right off Antelope Flats Road. Bison often graze nearby — stay 25 yards back.", map: "Mormon Row Historic District" },
        { time: "~2:45 PM", title: "📸 Snake River Overlook", detail: "Ansel Adams’ viewpoint — the river bend with the peaks beyond. A quick stop on US-89 heading north.", map: "Snake River Overlook" },
        { time: "~3:15 PM", title: "🏞 Jenny Lake — lakeshore walk", detail: "The prettiest lake in the park. A 30-min easy walk along the shore from the visitor center is plenty (taper week — no big hikes).", map: "Jenny Lake" },
        { time: "~4:00 PM", title: "🦌 Oxbow Bend", detail: "Mount Moran reflected in the Snake River; moose and elk at dusk. Northernmost stop — from here it’s straight north to Yellowstone.", map: "Oxbow Bend Turnout" },
        { time: "4:30 PM", title: "🚗 North through the South Entrance → West Thumb", detail: "Leave Oxbow by 4:30pm. Yellowstone’s South Entrance is ~40 min, then West Thumb Geyser Basin (30 min: lakeside geysers, Fishing Cone) — you won’t need to come back here later. Then west past Old Faithful → Madison → West Yellowstone. Sunset ~7:35pm; drive slowly at dusk, animals are on the road.", map: "West Thumb Geyser Basin" },
      ...
      tips: [
        "Running late (leaving Teton after ~5:30pm)? Take the Idaho route instead: Jackson → Teton Pass → Victor → Ashton → Island Park → West Yellowstone (~2h45, no wildlife jams, lit highway).",
    ...
    },
    {
      ...
      summary: "The closest, highest-payoff day: the Firehole River geyser basins, Grand Prismatic from the overlook, an Old Faithful eruption, and the Upper Geyser Basin boardwalks. 8–10 km of flat boardwalk — perfect active recovery.",
      blocks: [
        { time: "8:00 AM", title: "🌊 Firehole Canyon Drive & Firehole Falls", detail: "Just past Madison Junction — a 2-mile one-way scenic side road to a 40-ft waterfall. 10 minutes.", map: "Firehole Falls" },
        { time: "9:00 AM", title: "🫧 Fountain Paint Pot", detail: "All four thermal features on one short loop: mud pots, fumaroles, hot springs and geysers (Clepsydra erupts almost constantly). 30 minutes.", map: "Fountain Paint Pot" },
        { time: "9:45 AM", title: "🌈 Midway Geyser Basin — Grand Prismatic up close", detail: "Boardwalk past Excelsior Geyser’s steaming crater to the rim of Grand Prismatic. Steam is heaviest on cool mornings — the overlook next gives you the full colours.", map: "Grand Prismatic Spring" },
        { time: "10:45 AM", title: "🥾 Fairy Falls Trail → Grand Prismatic Overlook", detail: "From the Fairy Falls trailhead, 1.2 km each way on a flat trail then a short climb to the overlook — THE aerial view of the rainbow rings. ~1 hour round trip.", map: "Fairy Falls Trailhead" },
        { time: "12:30 PM", title: "⛲ Old Faithful + Old Faithful Inn", detail: "Check the next predicted eruption at the visitor center or in the NPS app (every ~90 min, ±10). Grab a bench 15 min early. Then the historic Inn lobby next door.", map: "Old Faithful" },
        { time: "1:30 PM", title: "🚶 Upper Geyser Basin boardwalk — Morning Glory Pool", detail: "The 2.4 km boardwalk past Castle, Grand and Riverside geysers to Morning Glory Pool. Grand Geyser’s predicted window is on the visitor-center board — worth waiting if it’s within 30 min.", map: "Morning Glory Pool" },
        { time: "4:00 PM", title: "🧿 Biscuit Basin & Black Sand Basin", detail: "Two small, colourful basins on the way back — Sapphire Pool and Emerald Pool. 20 minutes each.", map: "Biscuit Basin" },
        { time: "5:30 PM", title: "🦬 Back via Madison — dusk wildlife", detail: "Bison and elk graze the Madison River meadows in the evening. Pull over at the turnouts; stay in or beside the car.", map: "Madison Junction" }
      ],
      eat: "Cook breakfast; pack lunch (rice + protein) and eat it at Old Faithful; dinner at the rental.",
      tips: [
        ...
        "Taper: a 25–30 min easy run in West Yellowstone this morning + 6 × 20s strides, then the boardwalks are your recovery walk.",
        "Mornings are ~30°F: fleece + shell + beanie; you’ll shed layers by 11am."
      ]
    },
    {
      date: "2026-09-16",
      city: "West Yellowstone",
      title: "Yellowstone Day 2 · Grand Canyon, Hayden Valley & the Lake",
      summary: "East to the Grand Canyon of the Yellowstone for the Lower Falls from both rims, then slowly through Hayden Valley for bison, the Mud Volcano, and Yellowstone Lake — returning through Hayden at dusk when wildlife is out.",
      blocks: [
        { time: "7:30 AM", title: "🚗 Depart → Canyon Village", detail: "Madison → Norris → Canyon, ~1.5 hrs. Norris gets its own morning on Day 4, so pass it today.", map: "Canyon Village" },
        { time: "9:15 AM", title: "💦 North Rim — Brink of the Lower Falls & Lookout Point", detail: "Brink of the Lower Falls: a steep 1 km round trip (180 m down and back up) to stand at the lip of the 94 m waterfall — today’s one leg workout. Then Lookout Point and Grand View from the rim road.", map: "Brink of the Lower Falls" },
        { time: "11:00 AM", title: "🎨 South Rim — Artist Point", detail: "The classic painting view of the Lower Falls and the yellow canyon walls. A 5-minute walk from the parking lot.", map: "Artist Point" },
        { time: "1:00 PM", title: "🦬 Hayden Valley — bison & wildlife", detail: "Drive slowly, use the turnouts. Bison herds, elk, sometimes grizzlies and wolves in the distance — binoculars. Never approach; 25 yards from bison, 100 from bears.", map: "Hayden Valley" },
        { time: "2:00 PM", title: "🌋 Mud Volcano & Dragon’s Mouth Spring", detail: "Sulphurous, churning mud features on a short boardwalk loop. 30 minutes.", map: "Mud Volcano" },
        { time: "2:45 PM", title: "🏞 Fishing Bridge & Lake Yellowstone Hotel", detail: "The huge alpine lake (7,733 ft). Walk the shore, peek into the 1891 Lake Hotel sunroom. 45 minutes.", map: "Lake Yellowstone Hotel" },
        { time: "3:45 PM", title: "🌅 Back through Hayden Valley at dusk → home", detail: "Retrace north through Hayden Valley — animals are most active late afternoon — then Canyon → Norris → Madison → West Yellowstone (~2 hrs)." }
      ],
      eat: "Packed lunch at the Canyon Village picnic area; dinner at the rental.",
      tips: [
        "West Thumb was done on the way in (Sep 14), so today skips the lake’s west-shore loop and returns via Norris — shorter.",
    ...
    },
    {
      date: "2026-09-17",
      city: "West Yellowstone",
      title: "Yellowstone Day 3 · Lamar Valley wildlife, Tower Fall & Mammoth",
      summary: "The big wildlife day: a predawn run to Lamar Valley for wolves and bison, then Tower Fall, and Mammoth Hot Springs’ terraces with the September elk rut. ~250 miles — mostly driving and watching, so it’s a light day on the legs.",
      blocks: [
        { time: "5:30 AM", title: "🌄 Predawn departure → over Dunraven Pass", detail: "Madison → Norris → Canyon → Dunraven Pass (8,859 ft, sunrise views of Mount Washburn) → Tower Junction. ~2.5 hrs. If sleep matters more this week, leave at 6:30 — animals are still active until 9–10am in September.", map: "Dunraven Pass" },
        { time: "8:00 AM", title: "🐺 Lamar Valley — wolves, bison, pronghorn", detail: "America’s Serengeti. Park at the turnouts between Tower and Soda Butte and glass the valley with binoculars; watch for the wolf-watchers’ spotting scopes and join them. Bison cross the road constantly.", map: "Lamar Valley" },
        { time: "11:00 AM", title: "🏞 Tower Fall & Roosevelt", detail: "132-ft waterfall viewpoint, 5 minutes from the parking lot. Coffee at the Roosevelt Lodge area.", map: "Tower Fall" },
        { time: "1:30 PM", title: "🪨 Mammoth Hot Springs — terraces & the elk rut", detail: "Travertine terraces on the Upper and Lower boardwalks (~1.5 hrs). In September bull elk bugle on the Mammoth lawns — spectacular, but they charge: stay 25+ yards and keep the car between you and them.", map: "Mammoth Hot Springs" },
        { time: "4:00 PM", title: "🚗 Home via Norris", detail: "Mammoth → Norris → Madison → West Yellowstone, ~1h45. Early dinner, foam-roll, sleep — you’re three days out from the race." }
      ],
      eat: "Breakfast in the car (congee in a thermos + buns); lunch at Roosevelt / Mammoth; dinner at the rental — start upping the carbs tonight.",
      tips: [
        "⚠️ Road work at the Yellowstone River Bridge by Tower Junction: single lane with a signal, up to 30-min waits, through Sep 30 — budget it both directions.",
        "Binoculars are the difference between ‘saw a wolf’ and ‘saw a dot’. A thermos of hot congee makes the predawn wait pleasant.",
        "Taper day: driving + boardwalks only. 10 min of stretching / foam rolling tonight; sleep is the priority.",
        "Dunraven Pass is open (closes Oct 12) — check the NPS road status the night before in case of early snow."
      ]
    },
    {
      date: "2026-09-18",
      ...
      summary: "A relaxed last park day two days before the race: Norris (the hottest, oldest basin, home to Steamboat), a couple of short stops, an afternoon rest, and a sunset — then pack and start proper carb-loading.",
      blocks: [
        { time: "9:00 AM", title: "♨️ Norris Geyser Basin — Porcelain & Back Basin", detail: "Two boardwalk loops (~2 hrs, flat): Porcelain Basin’s milky-blue pools and Back Basin with Steamboat, the world’s tallest active geyser (unpredictable, but it steams impressively).", map: "Norris Geyser Basin" },
        { time: "11:30 AM", title: "🎨 Artists Paintpots & Gibbon Falls", detail: "A 1.6 km loop to colourful mud pots, then Gibbon Falls from the roadside pullout on the way home.", map: "Artists Paintpots" },
        { time: "1:00 PM", title: "🏠 Lunch & rest in West Yellowstone", detail: "Big carb lunch, feet up. Tidy the rental and start packing — checkout is tomorrow morning.", map: "West Yellowstone Montana" },
        { time: "3:00 PM", title: "🥾 Optional: Mystic Falls short hike or a last geyser", detail: "Mystic Falls from Biscuit Basin is a gentle 3.5 km round trip — or just revisit Old Faithful for Grand / Riverside if you missed them. Skip Mount Washburn (1,400 ft of climbing) — wrong week for it.", map: "Biscuit Basin" },
        { time: "Evening", title: "🌇 Sunset at Madison, then pack", detail: "Last light on the Madison meadows. Home for a carb-heavy dinner (rice, noodles, steamed buns), pack the car, early night — tomorrow leaves at 11am.", map: "Madison Junction" }
      ],
      eat: "Carb-loading starts in earnest: rice / noodles / buns at every meal, lean protein, easy on fat and fibre.",
      tips: [
        "D-2 shakeout: 15–20 min easy jog + 4 × 15s strides + a light rehearsal of the stations (10 air-squat-to-press, 20 walking lunges, a few burpees) — technique only, nothing hard.",
  ...
  // ---- Packing list ----
  packing: {
    "Essentials": ["ID / driver’s licence (for the rental)", "Credit cards + a little cash", "Phone + car charger + power bank", "Starlink Mini + power (12V / USB-C) + app signed in", "Offline maps + NPS app downloaded", "Park pass / receipt", "Water bottles (2+) — altitude & dry air", "Sunscreen, sunglasses, lip balm (strong sun at 7,000 ft)", "Headlamp (predawn Lamar start)", "Binoculars 🐺"],
    ...
    "Hiking & wildlife": ["🐻 Bear spray (buy on arrival — cannot fly)", "Day pack", "Trail snacks", "Thermos (congee for the predawn drive)", "Blister plasters / small first-aid kit", "Camera / phone lens wipe (geyser steam)"],
...
const PLACES = {
  ...
  "Dunraven Pass": [44.7873, -110.4560],
