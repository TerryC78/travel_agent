...
const TRIP_ZH = {
  ...
  days: [
    ...
    },
    {
      ...
      summary: "从容的晚出发、由东向西逛国家广场：已订的上午11:20国会大厦导览、下午1点航空航天、全新（免费）的白宫体验馆 The People's House，最后夜里看亮灯的林肯纪念堂。",
      blocks: [
        ...
        { time: "约下午3:15", title: "🏛 The People's House：白宫体验馆", detail: "航空航天看完直接过去——这是 2024 年新开的沉浸式免费白宫博物馆，地址 1700 Pennsylvania Ave NW（入口在17街），离真正的白宫只有几步、正对艾森豪威尔行政楼。互动展览、等比例的椭圆形办公室和国宴楼层、讲述白宫及其幕后工作人员的故事。⚠️ 在 thepeopleshouse.org 预约免费定时票——9点–17点开放，但**最晚入场16:00**，所以航空航天看完别拖。", map: "The People's House Washington DC" },
        { time: "下午晚些", title: "国家自然历史博物馆——免预约（可选）", detail: "如果还有精力，自然历史博物馆就在广场上（免费、无需门票，开到17:30）——希望钻石、恐龙、圆厅大象。这是今天的机动项：The People's House 16:00截止入场，时间紧就放心跳过。", map: "National Museum of Natural History Washington DC" },
      ...
      tips: ["今天顺序很重要：The People's House 最晚入场16:00，所以航空航天看完直接过去——自然历史博物馆是可以省略的机动项。", "在 thepeopleshouse.org 预约 The People's House 的免费定时票（建议捐$15，非强制）。", "动线由东向西——国会山 → 航空航天 → The People's House（白宫旁）→ 林肯纪念堂，大多步行。", "林肯纪念堂夜景是重头戏——留到晚上、亮灯又凉快。穿舒服的鞋、带水，给父母放慢节奏。"]
    },
    {
  ...
  bookings: [
    ...
    "🎟️ The People's House（6月27日下午）：在 thepeopleshouse.org 预约免费定时票——最晚入场16:00。",
