...
const TRIP_ZH = {
  ...
  highlights: [
    ...
    "🚗 华盛顿到纽约你们自驾（单程租车，沿 I-95，中途停费城）——上午7:45的 Amtrak 已取消。",
  ...
  days: [
    ...
    {
      title: "自驾 华盛顿→纽约（经费城）· 联合国导览与帝国大厦",
      summary: "不坐火车了，改自驾：租一辆单程车沿 I-95 直奔费城（自由钟与独立厅）停约30–45分钟——跳过巴尔的摩和午饭——再开到联合国，下午2:15到、赶3:15的中文导览；之后还车、入住时代广场，最后帝国大厦登顶、夜逛时代广场。（上午7:45的 Amtrak 已取消，作为备选保留在预订清单里。）",
      blocks: [
        { time: "约上午8:00", title: "🚗 取租车、从华盛顿出发（火车已取消）", detail: "上午7:45的 Amtrak 取消了——改成自驾。在华盛顿取一辆单程租车（提前预约：华盛顿取车、纽约还车），装好行李，直接开往费城——跳过巴尔的摩、也不专门停下吃午饭。全程约140英里/约2.5–3小时，约8:00出发，到联合国有充裕的缓冲。" },
        { time: "约上午11:00", title: "🔔 费城——自由钟与独立厅（唯一一站）", detail: "从华盛顿直接开约2.5–3小时。美国的诞生地：自由钟（免费，不进去隔着玻璃也能看到）和马路对面的独立厅——《独立宣言》和《美国宪法》就在这里签署，正好接上你们在华盛顿的历史行程。省掉巴尔的摩和午饭后时间有点富余，停约30–45分钟就好；想吃就买个芝士牛肉堡带走。约11:45出发。" },
      ...
      eat: "今天不专门停下吃午饭——想吃就在费城买个芝士牛肉堡带走；帝国大厦之后在 Hell’s Kitchen（9th Ave）吃晚饭。",
      tips: ["🚗 提前订单程租车（华盛顿取车 → 纽约还车）——会有单程费；在时代广场/宾州车站附近还车，比在曼哈顿停4晚划算。", "⏱ 现在只有一站（巴尔的摩和午饭都跳过了），这天挺从容——约8:00从华盛顿出发，约11:00到费城，时间很宽裕。最后进曼哈顿的堵车+停车是唯一变数。", "🛂 联合国导览：必须带护照 + 带照片的证件。约2:15到 1st Ave 和 46 街；3:15导览，约1小时。", "🔔 费城和你们在华盛顿的行程正好呼应：自由钟和独立厅就是《独立宣言》《宪法》签署的地方。", "🎟️ 帝国大厦 + One World（7月1日）+ 洛克菲勒之巅（7月2日）都在 Go City 通票里——记得在 App 里预约时段。"]
    },
    {
  ...
  logistics: [
    ...
    { label: "华盛顿→纽约", value: "🚗 自驾（单程租车），6月30日（周二）：沿 I-95 从华盛顿到纽约，中途在费城停约30分钟（跳过巴尔的摩和午饭），下午约2:15到联合国。（上午7:45的 Amtrak——联合车站→宾州车站约11:14——已取消，作为备选保留。）" },
  ...
  bookings: [
    ...
    "🚗 已改 — 华盛顿→纽约改为单程自驾租车（6月30日），中途经费城；记得订车。上午7:45的 Amtrak 已取消（作为备选保留）。",
    ...
    "🚗 租车：确认单程预订（华盛顿取车、纽约还车），并把 I-95 沿线（含费城一站）的驾驶导航离线下载好。",
