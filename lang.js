...
const TRIP_ZH = {
  ...
  highlights: [
    ...
    "🚗 华盛顿到纽约你们自驾（单程租车，沿 I-95，中途停巴尔的摩和费城）——上午7:45的 Amtrak 已取消。",
  ...
  days: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { time: "夜晚", title: "🏛 林肯纪念堂与夜游纪念碑", detail: "国家广场的压轴，最美在日落（约8:37pm）之后——尽量8:30–9:00pm到，赶上“蓝调时刻”（深蓝天空＋亮灯纪念碑＝最容易出片）。登上台阶进入大厅，看打着灯的林肯坐像和墙上镌刻的葛底斯堡演说；台阶上还能找到标记马丁·路德·金发表《我有一个梦想》演说的位置。📸 经典机位：站在台阶顶端朝东拍——倒影池里映着亮灯的华盛顿纪念碑（更远处是国会大厦）。之后沿倒影池往东散步到二战纪念碑和华盛顿纪念碑。", map: "Lincoln Memorial Washington DC" }
      ],
      eat: "导览前后在国会游客中心咖啡厅或买点带走的；航空航天之后再吃个迟午餐；晚餐在 Penn Quarter / 中国城。",
      tips: ["减少通勤：国会山 → 航空航天 → 自然历史 → 林肯纪念堂，沿国家广场由东向西一条线走完，不用坐地铁。", "时间安排：国会大厦导览11:20（约11:00到过安检），再步行约12分钟到航空航天赶下午1:00。", "晚一点出发、比较从容，适合父母。广场来回约2英里——穿舒服的鞋、带水、放慢节奏。", "林肯纪念堂夜景是重头戏——留到晚上,亮灯又凉快。", "🌃 夜游交通：晚饭后打 Uber 到林肯纪念堂（3人约$10–14），约8:30–9pm到赶上蓝调时刻，再沿亮灯的广场往东走到华盛顿纪念碑；回程走到 Foggy Bottom 地铁站或再打 Uber（约$12–15）。", "📸 最佳机位：站在林肯台阶顶端朝东拍倒影池＋亮灯的华盛顿纪念碑，手机开夜景模式。♿ 父母若走台阶吃力，纪念堂北侧有电梯。"]
    },
    {
      ...
      blocks: [
        ...
        { time: "夜晚", title: "🏛 乔治城大学与华盛顿纪念碑", detail: "傍晚去城西和广场逛逛：先走走历史悠久的乔治城大学校园（Healy Hall 的尖顶、绿树成荫的庭院），再到华盛顿纪念碑脚下——亮灯的方尖碑，沿广场一直望到林肯纪念堂和国会大厦，视野开阔。", map: "Washington Monument" }
      ],
      eat: "午餐在 NMAAHC 馆内的 Sweet Home Café；晚餐在乔治城一带或酒店附近随意吃。",
    ...
    {
      title: "阿灵顿、美国历史博物馆与黄昏的潮汐湖",
      summary: "上午过河到弗吉尼亚——阿灵顿国家公墓和五角大楼9/11纪念园（两个加起来约3小时）；下午在国家广场看美国历史博物馆；傍晚绕潮汐湖散步，去罗斯福纪念馆和杰斐逊纪念堂——日落时打着灯、倒映在水里，特别美。",
      blocks: [
        ...
        { time: "下午", title: "🏛 国家美国历史博物馆", detail: "过河回到国家广场过下午。真正的历史在楼上：2楼看星条旗（1814年那面真旗）和“美国民主”展里杰斐逊的写字桌；3楼看“美国总统”展（林肯的高礼帽）、第一夫人礼服、“自由的代价：美国人与战争”。1楼是交通与发明。旁边就是免费的国家美术馆，有精力可以加。", map: "National Museum of American History" },
        { time: "夜晚", title: "🌅 黄昏潮汐湖——罗斯福与杰斐逊纪念堂", detail: "用全城最美的黄昏散步给华盛顿这段收尾。绕潮汐湖一圈：罗斯福纪念馆（层层叠水、刻满名言的花岗岩“房间”）、紧挨着的马丁·路德·金纪念碑、还有圆顶的杰斐逊纪念堂——日落（约8:36pm）时打着灯、倒映在水中，美极了。打 Uber 过去（约$12–15）走一圈。今晚把行李收好——明天自驾去纽约。", map: "Thomas Jefferson Memorial" }
      ],
      eat: "午餐在国家广场一带；晚餐在潮汐湖附近或酒店附近随意吃。",
      tips: ["阿灵顿 + 五角大楼纪念园只隔一站地铁——上午一起看完（约3小时，坡地上走很多路，穿舒服的鞋）。", "🏛 美国历史博物馆要这样逛：真正的历史在2、3楼——2楼星条旗和杰斐逊的写字桌，3楼“美国总统”、第一夫人、“自由的代价”。1楼是交通与发明。", "🌅 潮汐湖的几座纪念碑（罗斯福、马丁·路德·金、杰斐逊）黄昏最美——亮灯又凉快、倒映在水里，日落约8:36pm。环湖一圈约1.5英里，平路好走。", "今晚收拾行李——明天是自驾去纽约，不坐火车了（那班7:45的 Amtrak 已取消）。"]
    },
    {
      title: "自驾 华盛顿→纽约（经巴尔的摩、费城）· 联合国导览与帝国大厦",
      summary: "不坐火车了，改自驾：租一辆单程车沿 I-95 北上，中途在巴尔的摩（内港）和费城（自由钟与独立厅）各停约30分钟，算好时间下午2:15到联合国赶3:15的中文导览——之后还车、入住时代广场，最后帝国大厦登顶、夜逛时代广场。（上午7:45的 Amtrak 已取消，作为备选保留在预订清单里。）",
      blocks: [
        { time: "约上午7:30", title: "🚗 取租车、从华盛顿出发（火车已取消）", detail: "上午7:45的 Amtrak 取消了——改成自驾。在华盛顿取一辆单程租车（提前预约：华盛顿取车、纽约还车），装好行李，争取约8:00上 I-95 北行。全程约225英里/约4小时车程，外加两个短停，所以早点出发才赶得上联合国。" },
        { time: "约上午9:00", title: "🦀 巴尔的摩——内港（停约30分钟伸展一下）", detail: "第一站，离华盛顿约1小时。在内港海滨走走——星座号帆船、城市天际线，来杯咖啡。停在海滨停车楼。（历史彩蛋：升起星条旗的麦克亨利堡就在约10分钟车程外，想去也行。）约9:30继续上路。" },
        { time: "约上午11:15", title: "🔔 费城——自由钟与独立厅（约30分钟）", detail: "离巴尔的摩约1小时45分。美国的诞生地：自由钟（免费，不进去隔着玻璃也能看到）和马路对面的独立厅——《独立宣言》和《美国宪法》就在这里签署，正好接上国家档案馆。喜欢的话买个芝士牛肉堡带走。约11:45出发。" },
        { time: "下午2:15", title: "🛂 到达联合国——带护照 + 证件", detail: "离费城约2小时15分（曼哈顿堵车 + 停车是变数，多留点时间）。把车停在联合国/中城东侧的停车楼。约2:15到访客入口（1st Ave 和 46 街），赶3:15的导览；安检是机场级别，**必须带护照 + 带照片的证件**。" },
        { time: "下午3:15", title: "✅ 联合国——中文导览团（已预约）", detail: "你们预约的中文导览3:15开始——联合国大会堂、安理会会议厅、各国捐赠的艺术品。约1小时。" },
        { time: "约下午5:00", title: "🚗 还车、入住 Candlewood Suites 时代广场", detail: "导览后开车约15分钟，把单程租车还在时代广场/宾州车站附近（比在曼哈顿停4晚便宜太多），然后入住 Candlewood Suites——纽约四晚唯一的落脚点。" },
        { time: "下午5:45", title: "帝国大厦登顶 — 🎟️ Go City 通票", detail: "从酒店步行/打车约10分钟。5:45到黄昏最棒——在86层观景台同时看到白天、日落和城市亮灯。在 Go City App 里预约时段免排队（自驾若晚点，时间可灵活调整）。" },
        { time: "夜晚", title: "夜晚的时代广场 + 晚餐", detail: "逛灯火全开的时代广场（你们就住这儿）。晚餐往西几个街区的 Hell’s Kitchen（9th Ave）比广场里好太多。" }
      ],
      eat: "中午在费城买个芝士牛肉堡（或路上吃点带走的）；帝国大厦之后在 Hell’s Kitchen（9th Ave）吃晚饭。",
      tips: ["🚗 提前订单程租车（华盛顿取车 → 纽约还车）——会有单程费；在时代广场/宾州车站附近还车，比在曼哈顿停4晚划算。", "⏱ 时间紧但可行：约8:00从华盛顿出发，每站控制在约30分钟。来不及就跳过巴尔的摩——费城最不该错过。曼哈顿堵车+停车可能多花30分钟，留好缓冲。", "🛂 联合国导览：必须带护照 + 带照片的证件。约2:15到 1st Ave 和 46 街；3:15导览，约1小时。", "🔔 费城和你们在华盛顿的行程正好呼应：自由钟和独立厅就是《独立宣言》《宪法》签署的地方。", "🎟️ 帝国大厦 + One World（7月1日）+ 洛克菲勒之巅（7月2日）都在 Go City 通票里——记得在 App 里预约时段。"]
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        { time: "晚上10:33", title: "✅ 落地旧金山 → Lyft 回家（已预约）", detail: "太平洋时间晚上10:33落地旧金山。回家的 Lyft 已经约好——取完行李，按“Ride App / 网约车”指示牌走到上车点即可。横跨美国飞了一天，回家的车提前订好最省心。欢迎回家！" }
      ],
  ...
  logistics: [
    ...
    { label: "华盛顿→纽约", value: "🚗 自驾（单程租车），6月30日（周二）：沿 I-95 从华盛顿到纽约，中途在巴尔的摩和费城各停约30分钟，下午约2:15到联合国。（上午7:45的 Amtrak——联合车站→宾州车站约11:14——已取消，作为备选保留。）" },
  ...
  bookings: [
    ...
    "✅ 已完成 — 旧金山机场回家的 Lyft（7月4日晚，落地约10:33后）",
    "🚗 已改 — 华盛顿→纽约改为单程自驾租车（6月30日），中途经巴尔的摩和费城；记得订车。上午7:45的 Amtrak 已取消（作为备选保留）。",
    ...
    "🎟️ The People's House（6月28日）：在 thepeopleshouse.org 预约免费的 9:00 开门场——赶在11点 NMAAHC 之前看完。",
    ...
    "🚗 租车：确认单程预订（华盛顿取车、纽约还车），并把 I-95 沿线（含巴尔的摩、费城两站）的驾驶导航离线下载好。",
  ...
  packing: {
    ...
    "Smart extras": ["日用双肩包", "便携风扇 / 降温毛巾", "路上的零食", "离线地图 + 驾驶导航 + 航空公司 App", "所有预订的离线存档/打印件"]
  }
};
