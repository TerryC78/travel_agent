...
const TRIP_ZH = {
  ...
  days: [
    ...
    },
    {
      ...
      summary: "沿国家广场由东向西一路走——全程步行、几乎不用通勤：国会山、上午11点的航空航天博物馆、一座博物馆，最后夜里看亮灯的林肯纪念堂和各纪念碑。",
      blocks: [
        { time: "上午9:00", title: "🏛 国会山（国会大厦）", detail: "从国家广场东端开始。走国会大厦的园区和宏伟的西立面、国会图书馆（华美的杰斐逊大楼）、对街的最高法院。想进国会大厦内部，要提前在 visitthecapitol.gov 预约免费导览——否则外观和园区可自由参观。从这里到航空航天博物馆约10分钟。", map: "United States Capitol" },
        { time: "上午11:00", title: "✅ 国家航空航天博物馆（已订2张票）", detail: "你们的定时票是上午11:00——提前约10分钟到过安检。就在国家广场东端、国会山旁边。提醒：截至2026年6月底只开放了约一半（8个全新展厅 + 翻新的天文馆）；建馆50周年再开5个展厅是在7月1日，刚好在你们离开之后。", map: "National Air and Space Museum Washington DC" },
      ...
      tips: ["减少通勤：国会山 → 航空航天 → 自然历史 → 林肯纪念堂，沿国家广场由东向西一条线走完，不用坐地铁。", "全长约2英里、走路很多——穿舒服的鞋、带水，给父母放慢节奏。", "想进国会大厦内部？提前在 visitthecapitol.gov 订免费导览。", "林肯纪念堂夜景是重头戏——留到晚上,亮灯又凉快。"]
    },
    {
  ...
  packing: {
    "Essentials": ["证件 / REAL ID（登机用）", "🛂 护照——联合国导览（6月30日）必须带；也可作为备用带照片证件", "💳 Bank of America 实体卡——7月4日大都会免门票", "🎟️ 谷歌工牌——在华盛顿和纽约的一些热门博物馆可能可以免费入场（如企业/文化福利）；带上它、在售票处问一问", "手机 + 充电器 + 充电宝", "银行卡 + 少量现金", "可重复使用的水壶", "防晒霜 + 墨镜 + 帽子"],
