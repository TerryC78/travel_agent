...
const TRIP_ZH = {
  ...
  highlights: [
    ...
    "🚆 华盛顿到纽约你们坐火车（Amtrak，约3.5小时，抵达纽约宾州车站）——比这一段坐飞机方便太多。",
  ...
  days: [
    ...
    {
      title: "阿灵顿、五角大楼与美国历史",
      summary: "上午过河到弗吉尼亚——阿灵顿国家公墓和五角大楼9/11纪念园（只隔一站地铁）；下午回到国家广场来个“美国历史”主题：先看国家档案馆的立国文献，再重访美国历史博物馆（之后乔治城可选），然后早点休息，赶明天7:45的火车。",
      blocks: [
        ...
        { time: "约下午1:00", title: "📜 国家档案馆——美国的立国文献", detail: "过河回到国家广场。建议在 recreation.gov 订$1的定时票（约下午1:00），免去夏天排长队。在圆形大厅你会站在真迹前——《独立宣言》《美国宪法》《权利法案》，全城最“美国历史”的地方。楼下的 Public Vaults 展厅也很精彩。约1–1.5小时。", map: "National Archives Washington DC" },
        { time: "约下午2:45", title: "🏛 美国历史博物馆——这次直奔历史楼层（重访）", detail: "沿广场往西步行约10分钟。这次直接去真正讲历史的楼层：2楼看星条旗（1814年那面真旗）和“美国民主”展里杰斐逊起草《独立宣言》用的写字桌；3楼看“美国总统”展（林肯的高礼帽）、第一夫人礼服、“自由的代价：美国人与战争”。（你今天大概逛的1楼是交通与发明。）旁边就是免费的国家美术馆，想换换也行。", map: "National Museum of American History" },
        { time: "下午晚些", title: "乔治城（可选）", detail: "还有精力的话：鹅卵石街道、C&O 运河、海滨，沿 M 街和 Wisconsin 大道逛逛（喜欢甜点来个 Georgetown Cupcake）。不然就早点回去休息，为早班火车养精神。", map: "Georgetown Washington DC" },
      ...
      tips: ["🎟️ 国家档案馆：在 recreation.gov 订$1的定时票（约下午1:00）——夏天圆厅排队很长。里面是真迹：《独立宣言》《美国宪法》《权利法案》。", "🏛 美国历史博物馆要这样逛：真正的历史在楼上——2楼星条旗和杰斐逊的写字桌，3楼“美国总统”、第一夫人、“自由的代价”。1楼是交通与发明（容易以为“没什么历史”）。", "减少通勤：阿灵顿+五角大楼上午只隔一站地铁；档案馆和美国历史博物馆在广场上紧挨着，离酒店约10分钟。", "在华盛顿的最后一晚：把 Amtrak 车票存进 App、重新打包——明天7:45的早班车。"]
    },
    {
  ...
  logistics: [
    ...
    { label: "华盛顿→纽约", value: "✅ Amtrak，6月30日（周二）：华盛顿联合车站上午7:45 → 纽约宾州车站约上午11:14（约3小时29分）。" },
  ...
  bookings: [
    ...
    "✅ 已完成 — Amtrak 华盛顿→纽约（6月30日 上午7:45 → 11:14）",
    ...
    "🚆 Amtrak App：把华盛顿→纽约的车票（6月30日 上午7:45）存进 App，方便离线查看。",
