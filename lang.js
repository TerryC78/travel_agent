...
const TRIP_ZH = {
  ...
  days: [
    ...
    {
      title: "火车 华盛顿→纽约 · 帝国大厦与时代广场",
      summary: "坐火车抵达 Moynihan 大厅，入住时代广场的酒店（四晚都住这儿），然后去帝国大厦，晚上逛灯火通明的时代广场。",
      blocks: [
        ...
        { time: "约下午2:45", title: "✅ 入住 Candlewood Suites 时代广场", detail: "从 Moynihan/宾州车站步行约10分钟，或一站地铁就到酒店——不用往下城转车。放下行李、休整一下。这是你们纽约四晚唯一的落脚点，可以好好打开行李。" },
        { time: "下午5:00", title: "帝国大厦 — 🎟️ Go City 通票", detail: "步行约8分钟到帝国大厦（含在你们的 Go City 通票里）。傍晚到黄昏最棒——在86层观景台能同时看到白天、日落和城市亮灯。在 Go City App 里预约时段可免排队。" },
        { time: "夜晚", title: "夜晚的时代广场 + 晚餐", detail: "第一次看灯火全开的时代广场（你们就住这儿，会常经过）。晚餐往西几个街区的 Hell’s Kitchen（9th Ave）比广场里好太多。" }
      ],
      eat: "晚餐在 Hell’s Kitchen（9th Ave）——选择多，离酒店步行可达。",
      tips: ["到之前先设置好地铁的手机/银行卡刷卡（OMNY）。", "宾州车站到酒店步行可达——拖着行李也不用研究地铁。", "帝国大厦 + One World（7月1日）+ 洛克菲勒之巅（7月2日）都在 Go City 通票里——记得在 App 里预约时段。", "提醒：华盛顿的“Salute to America”250周年游行和烟花在7月4日——那时你们已经离开了。纽约才是你们的压轴。"]
    },
    {
    ...
    {
      title: "中央公园、大都会博物馆与黄昏天际线",
      summary: "从时代广场的落脚点出发逛上城——今天不换酒店。中央公园、大都会，然后黄昏登洛克菲勒之巅。",
      blocks: [
        { time: "上午", title: "中央公园", detail: "从时代广场坐地铁上城（约10分钟）。从哥伦布圆环进，逛 Bethesda 露台、林荫道、Bow 桥、眺望台城堡。可以租辆自行车，或一路往北闲逛。" },
        { time: "下午", title: "大都会艺术博物馆（博物馆大道）", detail: "大都会艺术博物馆世界一流——安排2–3小时。普通门票无需提前预约。附近备选：古根海姆，或穿过公园到美国自然历史博物馆。" },
        { time: "日落", title: "洛克菲勒之巅 — 🎟️ Go City 通票", detail: "回到中城，黄昏登洛克菲勒之巅（含在你们的 Go City 通票里）——经典天际线、帝国大厦入镜。在 Go City App 里预约日落时段，会卖光。离酒店步行即到。" }
      ],
      eat: "午餐在公园附近的上东/上西区；看完观景台回中城吃。",
      tips: ["今天不换酒店——你们已经住在时代广场，所以这天很轻松。", "🎟️ 洛克菲勒之巅在 Go City 通票里——在 App 里预约日落时段（会卖光）。", "这趟下来你们登了三个观景台（帝国大厦、One World、洛克菲勒之巅）——各是天际线的不同角度。", "中央公园很大——选哥伦布圆环这一片，别想全部走完。"]
    },
    {
    ...
    },
    {
      ...
      blocks: [
        { time: "上午", title: "纽约最后一个上午 + 250周年气氛", detail: "吃个贝果，在时代广场附近做最后的闲逛。城里到处都有 America250 的白天活动。从 Candlewood Suites 退房，想轻松几个小时就把行李寄存好。" },
      ...
      tips: ["下午3点左右离开曼哈顿——节日 + 250周年 = 机场堵车和排队极其夸张。", "上午从 Candlewood Suites 退房；想空着手过最后几小时就把行李寄存好。", "你们会错过现场的梅西烟花（在飞机上）——NBC/Peacock 晚上8–10点直播。"]
    }
  ],
